    ...
    <section className="py-16 sm:py-20 bg-black">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="text-center mb-10 sm:mb-16">
          {/* back btn */}
          <Link href="/" className="inline-flex items-center gap-2 text-sm text-white/80 hover:text-white transition-colors mb-6">
              ...
              <CardContainer className="inter-var w-full">
                <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl p-4 sm:p-6 border">
                  ...
                  <CardItem
                    as="p"
                    translateZ="60"
                    className="text-neutral-500 text-sm max-w-full mt-2 dark:text-neutral-300 line-clamp-3"
                  >
                    {project.description}
                  </CardItem>
                  ...
                  >
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-2 sm:px-3 py-1 text-[10px] sm:text-xs rounded-full bg-white/10 text-white/80"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-4 sm:mt-6">
                    {project.link && (
                      <CardItem
                        ...
                        className="px-3 sm:px-4 py-2 rounded-xl text-xs font-medium bg-white text-black hover:brightness-95 transition-all duration-200"
                      >
                        View Project →
                      </CardItem>
                    )}
